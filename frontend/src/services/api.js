...
/**
 * PRODUCTION SETUP:
 * This uses the environment variable 'VITE_API_URL' defined in Vercel.
 * If that variable is missing (like on your local machine), 
 * it falls back to '/api' which uses your Vite proxy.
 */
